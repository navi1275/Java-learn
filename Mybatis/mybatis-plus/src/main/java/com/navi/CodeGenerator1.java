...
public class CodeGenerator1 {
    ...
    private static final Boolean CREATE_ENTITY = false;

    private static final Boolean CREATE_MAPPER = true;
    private static final Boolean CREATE_DAO = false;

    private static final Boolean CREATE_SERVICE = false;
    private static final Boolean CREATE_SERVICEIMPL = false;
    ...
    private static final String DATABASE_URL = "jdbc:mysql://dbOs:3306/test?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    private static FileOutConfig getEntityOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(entityPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/vo/" + tableInfo.getEntityName() + "Vo" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getDaoOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(mapperPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/dao/I" + tableInfo.getEntityName() + "Dao" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getIServieOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(mapperPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/service/I" + tableInfo.getEntityName() + "Service" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getServieImplOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(mapperPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/service/impl/" + tableInfo.getEntityName() + "ServiceImpl" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getControllerOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(controllerPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/controller/" + tableInfo.getEntityName() + "Ctl" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getISvcOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(isvcPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/service/I" + tableInfo.getEntityName() + "Svc" + StringPool.DOT_JAVA;
            }
        };
    }
    ...
    private static FileOutConfig getSvcOutConfig(final String projectPath) {
        ...
        return new FileOutConfig(svcPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/com/navi/dept/service/impl/" + tableInfo.getEntityName() + "Svc" + StringPool.DOT_JAVA;
            }
        };
    }
